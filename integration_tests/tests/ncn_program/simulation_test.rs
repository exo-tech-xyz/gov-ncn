...
mod tests {
    ...
    use ncn_program_core::{constants::WEIGHT, ncn_reward_router::NCNRewardReceiver};
    ...
    async fn simulation_test() -> TestResult<()> {
        ...
        // Define which root and hash we expect to win in the vote
        ...
        // 6. Cast votes from operators
        {
            ...
            // Second and third operators vote for expected winner
            ncn_program_client
                .do_cast_vote(
                    ncn_pubkey,
        ...
        // TODO: Fix issues with close accounts
